"use client";
import { MoveLeft, MoveRight, Volume2 } from "lucide-react";
...
export default function Lesson() {
  ...
  return (
    <main>
            ...
            <div className="p-4" key={index}>
              <div className="p-3 bg-white mb-3">
                ...
                <div className="direction-ltr relative mb-2">
                  ...
                  <Volume2 size={20} className="absolute top-0 right-4" />
                </div>
                <div className="mb-8">
      ...
      <div className="flex items-center justify-between gap-12 px-8 mb-6">
        <button
          type="button"
        ...
        <button
          type="button"
          className="flex items-center gap-2 bg-green-800 hover:bg-green-900 text-white 
